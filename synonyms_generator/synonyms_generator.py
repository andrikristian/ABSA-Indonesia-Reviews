...
from User_Setting_Interface import synonyms_generator_path
...
args = parse_args()
vector_file = synonyms_generator_path + args.glove_path + '/' + 'glove.6B.' + str(args.vector_dim) + 'd.txt'
